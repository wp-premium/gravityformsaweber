...
class GFAWeberData{
    ...
    public static function update_table(){
        global $wpdb;
        $table_name = self::get_aweber_table_name();
    ...
    public static function get_aweber_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_aweber";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_aweber_table_name());
    }
}
